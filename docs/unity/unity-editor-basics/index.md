...
[Unity](https://unity.com/ja) は、世界で広く使われているゲームエンジンです。2D・3D を問わず、モバイル・PC・コンソール・XR など 25 以上のプラットフォーム向けにゲームを開発・配信できます。C# スクリプトを使った柔軟なゲームロジックの実装と、大規模なコミュニティ・エコシステムが特徴です。

![Unity概要](image-8.png)

このページでは、Unity Hub と Unity エディターを導入し、開発を始める準備を整えます。
